...
def get_args_parser():
    ...
    parser.add_argument('--lr', default=4e-4, type=str) #4e-4
    parser.add_argument('--max_iter', default=10000, type=int) #10000
    parser.add_argument('--log_freq', default=1000, type=str) #1000
    parser.add_argument('--batch_size', default=1, type=int) #2
    parser.add_argument('--num_workers', default=0, type=int)
    parser.add_argument('--type', default='vox', choices=['vox', 'point', 'mesh'], type=str)
    parser.add_argument('--n_points', default=10000, type=int) #5000
...
def train_model(args):
    ...
    plt.savefig(f'Graphs/loss_{args.type}.png')
