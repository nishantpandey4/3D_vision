"""
This script renders a tetrahedron and saves it as a gif file.
Usage:
    python -m starter.render_tetra
"""
import argparse
import imageio
...
def render_tetra(image_size=256, color=[0.5, 0.3, 0.6], device=None,):
    """
    Renders a tetrahedron.

    Args:
        image_size (int, optional): _description_. Defaults to 256.
        color (list, optional): _description_. Defaults to [0.5, 0.3, 0.6].
...
if __name__ == "__main__":
    ...
    image = render_tetra(image_size=args.image_size)
    imageio.mimsave('GIF/tetra.gif',image, duration=10,loop=0)
